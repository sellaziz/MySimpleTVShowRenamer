...
from module.search_tv_show import get_ep_list
from module.search_tv_show import get_best_matched_name
...
def find_rename(filename_list):
    ...
    # Associate Best Match with filenames
        for season in seasons.keys():
            ...
            ep_dicts[best_match].setdefault(season,get_ep_list(best_match,season))
        if debug:
